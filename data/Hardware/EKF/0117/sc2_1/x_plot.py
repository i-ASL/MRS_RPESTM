...
def xplot():
    ...
    color = 'tab:red'
    plt.plot(rosgbag_time, _esti_x, marker='s', linestyle='-', color=color, label='Estimation of Robot2 X')

    color = 'tab:blue'
    plt.plot(rosgbag_time, gt_robot2_x, marker='s', linestyle='-', color=color, label='GT of Robot2 X')
